...
class FlyerChat extends StatefulWidget {
  ...
  /// FlyerChat theme. Extend [ChatTheme] class to create your own theme or use
  ...
  @override
  State<FlyerChat> createState() => ChatState();
}

/// [FlyerChat] widget state.
class ChatState extends State<FlyerChat> {
  ...
  @override
  void didUpdateWidget(covariant FlyerChat oldWidget) {
