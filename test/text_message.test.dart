...
void main() {
  ...
  testWidgets('triggers visibility detection', (WidgetTester tester) async {
    ...
    assert(messagesVisible.length == 2 && messagesVisible.containsAll(<String>{'id', 'id2'}));
    ...
    assert(messagesVisible.length == 2 && messagesVisible.containsAll(<String>{'id3', 'previewId'}));
  });
}
